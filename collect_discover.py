"""
collect_discover.py — finds the latest Discover account activity export
in ~/Downloads and ingests it into raw/ (scrubbed).

Usage:
    python collect_discover.py [--force]

Discover requires a manual, login-gated export — there is no automated
...
PATTERN = "Discover-AllAvailable*.csv"
...
def main():
    ...
    if source_path is None:
        print(
            ...
            "Discover requires a manual login-gated export — download the "
            "Account Activity CSV from discover.com and save it to "
